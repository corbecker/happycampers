<?php
/* Template Name: Daycare Reservation New*/
get_header();
?>
<div class="masthead">
    <div class="container">
...
<div class="main-general container">
    ...
    <div class="flex-grid">
        <div class="vertical-row thin">
            <h3 class="left">Ready to get the ball rolling?</h3>
            <p>We can't wait to meet you and your furry friend. All our new guests are required to come for a trial day before joining the doggy daycare program. Please read our house rules below carefully and fill out an application form to bring with you to the trial.</p>
            ...
            <br>
            <h3 class="left">Request a Trial</h3>
            ...
            <div class="well space-bottom"><p>**Please note this is a reservation only. Please allow 24 hours for your request to be confirmed. If you need to get in touch immediately please call us on <a href="tel:(00353)852432902"><span>085 243 2902</span></a></p></div>
            <h3 class="left">Reservation Form</h3>
            <div class="form-well">
                <?php if (have_posts()) : ?>
